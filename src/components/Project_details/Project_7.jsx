...
import aboutImg from '../../images/proxy tool.png'
        ...
        <div className='about__wrapper'>
            <div>
                ...
                <ul >
                    ...
                    <li className='description about__content-desc'>Descriptive Analysis and Inferential Statistics:</li> 
                    <p className='description about__content-desc'> Descriptive analysis and inferential statistics were used to reveal the factors that affect the risk of reoffending among probationers. 
                    This was done by analyzing data collected from the selected sample of probationers.</p>
                    <li className='description about__content-desc'>Development of the Proxy Tool:</li> 
                    <p className='description about__content-desc'>Based on the findings from the descriptive analysis and inferential statistics, a proxy tool was developed to score probationers on their risk 
                    ...
                    <li className='description about__content-desc'>Development of the Validation Strategy:</li> 
                    <p className='description about__content-desc'> In order to ensure that the proxy tool was accurate and reliable, a validation strategy was developed. This included a thorough assessment of the tool's 
                    validity, reliability, and predictive accuracy.</p>
                    <li className='description about__content-desc'>Validation of the Tool and Recommendations: </li> 
                    <p className='description about__content-desc'>The final step was to validate the tool and provide recommendations for its use. The results of the validation showed that the proxy tool was effective 
